...
class MessageRK(Message):
    ...
    def get_no_depart_message(number: int) -> Message:
        """Get both title and text for machine/message number."""
        message = RK_NO_DEPART_MESSAGES.get(number)
        if message is None:
            return Message(title=f"Unknown no-depart message {number}")
        return message
...
class MessageRT(Message):
    ...
    def get_no_depart_message(number: int) -> Message:
        """Get both title and text for machine/message number."""
        message = RT_NO_DEPART_MESSAGES.get(number)
        if message is None:
            return Message(title=f"Unknown no-depart message {number}")
        return message


RK_TITLES: MappingProxyType[int, str] = MappingProxyType(
    {
        1: "Passed (not in use)",
        2: "Failure",
        3: "Wait…",
...
RK_STOP_MESSAGES: MappingProxyType[int, Message] = MappingProxyType(
    {
        2: Message(
        ...
        28: Message(
            ...
            text="Mower needs your help, please restart (28)",
        ),
        29: Message(
            title="Check mowing Height",
            text="Mower needs your help, please restart (29)",
        ),
        30: Message(
            title="No wire signal",
        ...
        39: Message(
            title="Failure", text="Stop button is pressed during manual operation"
        ),
        ...
        60: Message(
            title="Mowing motor problem",
            text="Mower needs your help, please restart (60)",
        ),
        67: Message(
            title="Failure",
            text="Mower needs your help, place mower in base station  (67)",
        ),
        69: Message(
            title="Wait…",
        ...
        92: Message(
            title="Bumper was pressed",
            text="Mower needs your help, please restart (92)",
        ),
        93: Message(
        ...
        95: Message(
            title="Bumper was pressed",
            text="Mower needs your help, please restart (95)",
        ),
        98: Message(
            title="Help needed; restart in new location",
        ...
        108: Message(
            title="Battery compartment door is open", text="Battery door is open"
        ),
        113: Message(
...
RT_MESSAGES: MappingProxyType[int, Message] = MappingProxyType(
    {
        1: Message(title="Passed", text="Operation Passed."),
        2: Message(
            title="Operation Failed.",
            text="The Test or Calibration performed has Failed.",
        ),
        ...
        17: Message(
            title="Start Inside",
            text="Place the mower inside the lawn and start it again.",
        ),
        18: Message(
            title="Stuck in Place",
        ...
        26: Message(
            title="Calibrate Wire Sensor 1",
            text="Turn wire signal 'Off' then press GO.",
        ),
        27: Message(
        ...
        501: Message(
            title="Wire signal off reading is higher than wire signal on reading"
        ),
        502: Message(
...
RT_NO_DEPART_MESSAGES: MappingProxyType[int, Message] = MappingProxyType(
    {
...
RK_NO_DEPART_MESSAGES: MappingProxyType[int, Message] = MappingProxyType(
    {
        0: Message(title="I'm home"),
        1: Message(
            title="Charging at home", text="Mower can not depart; battery not ready"
        ),
        2: Message(
            title="Inactive time", text="Mower cannot depart; outside scheduled time"
        ),
        3: Message(
            title="Mowing completed",
            text="Mower can not depart; required mow time is completed",
        ),
        4: Message(title="Mower can not depart; humidity/rain is detected"),
        6: Message(
            title="In demo mode", text="Mower can not depart; demo mode enabled"
        ),
        7: Message(
            title="Interface used", text="Departure is waiting for user interaction?"
        ),
        8: Message(
            title="Excess operation",
            text="Multiple consecutive short operations were detected",
        ),
        10: Message(
            title="Schedule is Off",
            text="Mower cannot depart; automatic schedule is turned off",
        ),
        11: Message(
            title="Schedule is Off",
            text="Mower cannot depart; automatic schedule is turned off",
        ...
        13: Message(
            ...
            text="Mower cannot depart; all days are set as inactive",
        ),
        14: Message(
            title="Out off base",
            text="Mower cannot depart; it is not in the docking station",
        ),
        15: Message(
            title="In charging", text="Mower cannot depart; battery in charge mode"
        ),
        16: Message(
            title="In charging", text="Mower cannot depart; battery in charge mode"
        ),
        ...
        21: Message(
            title="Stop pressed",
            text="Mower cannot depart; stop button is pressed or lifted",
        ),
        22: Message(
            title="Disabling Key !",
            text="Mower cannot depart; disabling key is removed",
        ),
        23: Message(
            title="Set date & time",
            text="Mower cannot depart; date and time must be set",
        ),
        24: Message(
            title="It's too hot", text="Mower cannot depart; temperature is too high"
        ),
        25: Message(
            title="Door is open", text="Mower cannot depart; interface door is open"
        ),
        26: Message(
            title="Battery door open", text="Mower cannot depart; battery door is open"
        ),
    }
)
